...
class CollisionChecker:
    ...
    def collision_check(self, paths, obstacles):
        ...
        for i in range(len(paths)):
            ...
            # print("rrrrrrrrrrrrrrjjjjjjjjjjjjjjjaaaaaaaaaa")
            for j in range(len(path[0])):
                ...
                # --------------------------------------------------------------
                # print("-------", self._circle_offsets*cos(path[2][j]))
                # print("Raj ------------------------")
                # print("self._circle_offsets: ", self._circle_offsets)
    ...
    def select_best_path_index(self, paths, collision_check_array, goal_state):
        ...
        for i in range(len(paths)):
            ...
            if collision_check_array[i]:
                # print("bbbbbbbbbooooooooobbbbbbbboooooooo  ",i )
                ...
                # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
                # --------------------------------------------------------------
                # print("bobobob: ",goal_state[0], goal_state[1])
                goal_d = np.linalg.norm(np.subtract(np.array([paths[i][0][-1], paths[i][1][-1]]),np.array([goal_state[0], goal_state[1]])))
                score = goal_d
                # --------------------------------------------------------------
